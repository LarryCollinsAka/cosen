        ...
        <div class="col-md-8 mx-auto">
            <div class="card shadow-sm">
                <div class="card-header bg-dark text-white">
                    <h3 class="mb-0">Create New Prompt</h3>
                </div>
                <div class="card-body">
                    <form action="{{ route('admin.prompts.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="incident_category" name="incident_category" value="{{ old('incident_category') }}" required>
                        </div>
                        <div class="mb-3">
                            <label for="question" class="form-label">AI Question</label>
                            <textarea class="form-control" id="question" name="question" rows="4" required>{{ old('question') }}</textarea>
                        </div>
